...
const AllQuesion = () => {
  ...
  const circle = (pi = 3.14, r = 4) => {
    return pi * r ** 2;
  };

  // rectangle

  const rectangle = (l = 10, w = 20) => l * w;
  ...
  return (
    <>
      ...
      <div>
        <h3>area of triangle is....{Triangle(15, 25, 35)} </h3>
      ...
      {/* Q-6 */}
      <div>
        <h3> even number {even + " "}</h3>
        <h3> odd number {odd + " "}</h3>
      </div>

      {/* Q-8 */}
      <div>
        <h3>merge above array...{r + " "}</h3>
      </div>
